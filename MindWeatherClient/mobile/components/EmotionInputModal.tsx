...
export function EmotionInputModal({ onClose, onSuccess }: EmotionInputModalProps) {
    const { user } = useAuth();
    ...
    return (
        <View style={{ backgroundColor: '#111827', width: '100%', maxWidth: 512, borderRadius: 16, overflow: 'hidden', height: '85%', margin: 16 }}>
            <ScrollView
                style={{ flex: 1 }}
